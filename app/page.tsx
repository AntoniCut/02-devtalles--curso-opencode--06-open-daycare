      ...
      <main className="flex-1 min-w-0 h-screen overflow-y-auto">
        <div className="max-w-[760px] w-full mx-auto px-10 pt-[34px] pb-20">
          ...
          <div className="mb-6">
            ...
            <p className="mt-[5px] text-[#94887B] text-[14.5px]">{classroom.childrenCount} niños · {classroom.date}</p>
          </div>

          {/*  -----  composer  -----  */}
          <Link
            href="/crear-publicacion"
            className="flex items-center gap-3.5 bg-[#FFFDF9] border border-[#ECE0D0] rounded-[18px] py-3.5 px-[18px] mb-6 shadow-[0_4px_14px_-10px_rgba(120,90,60,.4)]"
          >
